 ...
 * @param {string | number | boolean | null} [wrap] Word wrap column
...
function perform(action, message, wrap) {
  ...
  var col = wrap === undefined ? 40 : wrap === false || wrap === null ? undefined :parseInt(wrap.toString());
  ...
  // Box top
  var spanner = Array(lines.length === 1 && lines[0].length === 0 ? col !== undefined ? 2 : 3 : width + 3);
